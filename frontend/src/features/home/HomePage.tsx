              ...
              <div className="max-w-4xl">
                <div>
                  ...
                  <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--muted)] sm:text-lg">
                    deslop ships as a Rust CLI for Go, Python, and Rust repositories with explainable static signals, repository-local symbol awareness, parser-backed Go request-path packs for GORM and Gin, duplicate decode, multipart upload and dynamic bind waste, repeated split and strconv churn, scratch container and slice-clone churn, loop-local URL and time parsing, looped GORM CRUD, and request-path DB churn checks for Go, receiver-wrapper and context propagation checks, readable output, Cargo installs, published binaries, and GitHub Actions support for automation.
                  </p>
                </div>
