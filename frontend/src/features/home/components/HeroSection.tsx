  ...
  return (
    <section id="top" className="section-anchor relative pt-24 pb-24 sm:pt-32 sm:pb-32 lg:pt-40 lg:pb-40">
      <Container className="max-w-5xl mx-auto text-center">
        ...
        <h1 className="mt-6 mx-auto text-[clamp(3rem,8vw,5.5rem)] leading-[0.95] font-medium tracking-[-0.03em] text-[var(--text-strong)]">
          Code moves fast. <br className="hidden sm:block" />
          <span className="italic text-[var(--muted)]">Context is left behind.</span>
        </h1>
        <p className="mt-10 mx-auto w-full max-w-2xl text-[1.15rem] leading-[1.8] text-center text-[var(--muted)] sm:text-[1.35rem]">
