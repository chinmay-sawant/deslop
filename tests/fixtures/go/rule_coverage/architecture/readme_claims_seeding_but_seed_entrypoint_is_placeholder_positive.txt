...
// Positive scenario for readme_claims_seeding_but_seed_entrypoint_is_placeholder: shows the risky shape for this rule.
...
func PositiveReadmeClaimsSeedingButSeedEntrypointIsPlaceholder(c *gin.Context, db *gorm.DB, sqlDB *sql.DB) {
    var model UserModel
...
func (s *UserService) PositiveReadmeClaimsSeedingButSeedEntrypointIsPlaceholderService(c *gin.Context, dto UserModel, model UserModel) (gin.H, int, *gorm.DB) {
