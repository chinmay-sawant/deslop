...
const RUST_RULE_SPECS: &[RuleExecutionSpec] = &[
    ...
    RuleExecutionSpec {
        ...
        file_rules: &[rust_bad_practices_file_findings],
        indexed_file_rules: &[rust_bad_practices_indexed_file_findings],
        optional_function_rules: &[],
        function_rules: &[rust_bad_practices_function_findings],
        file_function_rules: &[],
        indexed_function_rules: &[],
        configurable_function_rules: &[],
        repo_rules: &[],
