...
- function docstrings, hash-comment summaries, local binding names, conservative exception-handler evidence, validation and duplicate-block signatures, and conservative test-file and test-function classification
