...
- Input file: `/home/chinmay/ChinmayPersonalProjects/deslop/temp_gopdfsuit.txt`
- Findings processed: **1883**
- Findings with readable source path: **1883/1883**

## Binary False-Positive Result

- `false_positive = true`: **33**
- `false_positive = false`: **1850**

## Verdict Totals

- `FALSE_POSITIVE`: **33**
- `NOT_FALSE_POSITIVE`: **349**
- `NEEDS_MANUAL_REVIEW`: **1501**
...
- `repeated_json_dumps_same_object`: 4
